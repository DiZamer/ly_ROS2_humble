...
class Metaclass_SetVelocity(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_service_interfaces.srv.SetVelocity')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_service_interfaces.srv import _set_velocity
...
class SetVelocity(metaclass=Metaclass_SetVelocity):
    from my_service_interfaces.srv._set_velocity import SetVelocity_Request as Request
    from my_service_interfaces.srv._set_velocity import SetVelocity_Response as Response
